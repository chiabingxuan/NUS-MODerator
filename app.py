...
def handle_registration(username_input: str, password_input: str, first_name_input: str, last_name_input: str, matriculation_ay_input: str, major_input: str) -> None:
    if not check_username_validity(username=username_input) or not check_password_validity(password=password_input):
...
def display_and_handle_auth_tabs() -> None:
    ...
    with login_tab:
        ...
        if login_button:
            handle_login(username_input=username_input, password_input=password_input)
    ...
    with register_tab:
        ...
        if register_button:
            handle_registration(username_input=username_input, password_input=password_input, first_name_input=first_name_input, last_name_input=last_name_input, matriculation_ay_input=matriculation_ay_input, major_input=major_input)
