...
from moderator.chatbot.prompts import REPHRASE_PROMPT, DOCUMENT_FORMAT_PROMPT, RETRIEVAL_QA_CHAT_PROMPT
from moderator.config import EMBEDDINGS_MODEL_NAME, VECTOR_STORE_FOLDER_NAME, VECTOR_EMBEDDINGS_FILENAME

load_dotenv()


def run_chatbot(query: str, chat_history: list[tuple[str, str]] = list()) -> dict[str, str]:
