...
st.markdown("This project was inspired by the course \"Develop LLM powered applications with LangChain\" on [Udemy](https://www.udemy.com/course/langchain/?srsltid=AfmBOop03tO6wEwm2yilQyRcysAl9VAgDja1VH9zKfJX5-N2EgK_JNr5&couponCode=LETSLEARNNOW). Yes, the course was hidden behind a paywall; no, I am not rich. Thankfully, though, I had free access to Udemy Business throughout my internship at Synapxe. So, I would like to thank Synapxe for hiring me - I genuinely learnt a lot during my time there too.")
