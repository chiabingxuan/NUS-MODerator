...
st.markdown("Shoutout to my senpai, [Roydon Tay](https://www.linkedin.com/in/roydon-tay/), for helping me out with the LangChain document retrieval process.")
st.markdown("Also a big thank you to my cousin, [Tan Xi En](https://www.linkedin.com/in/xi-en-tan-5b065b1b2/), for teaching me how to host databases on the cloud for free. You might have just become my favourite cousin.")
